    ...
    <form class="mx-auto max-w-xl p-6 bg-white rounded shadow-md dark:bg-gray-700" method="POST" action="{{ route('provisions.buy') }}">
        ...
        <div class="mb-4">
            ...
            <div class="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
                <input type="checkbox" name="buy_confirmation" id="buy_confirmation" class="toggle-checkbox absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer active:bg-blue"/>
                <label for="buy_confirmation" class="toggle-label block overflow-hidden h-6 rounded-full bg-gray-300 cursor-pointer"></label>
            </div>
        </div>
