...
class addProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'quantity' => ['required', 'numeric', 'min:0.01', 'regex:/^\d+([\.,]\d{1,2})?$/', 'max:9999999.99'],
            'price' => ['required', 'numeric', 'min:0.01', 'max:9999999.99', 'regex:/^\d+([\.,]\d{1,2})?$/'],
            'budget_id' => 'required',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'product_id.max' => 'O campo produto deve ser menor que 9.999.999',
            'quantity.required' => 'O campo quantidade é obrigatório',
            'quantity.min' => 'O campo quantidade deve ser maior que 0',
            'quantity.max' => 'O campo quantidade deve ser menor que 9.999.999,99',
            'quantity.regex' => 'O campo quantidade deve ser um número e ter até 2 casas decimais',
            'quantity.numeric' => 'O campo quantidade deve ser um número',
            'price.required' => 'O campo preço é obrigatório',
            'price.min' => 'O campo preço deve ser maior que 0',
            'price.max' => 'O campo preço deve ser menor que 9.999.999,99',
